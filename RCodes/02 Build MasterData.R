...
# En este script se genera la base master que consiste en unir las bases limpias diarias
# generadas en el proceso anterior. Adicional a esto, se realiza un proceso de limpieza extra.
...
# Se tiene la base master hasta el 13 de setiembre del 2018, esta base se le ha aplicado un proceso
# de reconstruccion especial para poder completar sus nombres.

# Este script toma la ultima actualizacion de la master data y le realiza el proceso de agregacion
# con la finalidad de unir a la base anterior
...
while(fecha <= fin_d){
  ...
  fname = paste0("../BaseDatos/R1/",fname)
...
fname_bd_rdata = paste0("../output/MasterData/",ini_d,"hasta",fin_d,".RData")
