...
load(paste0(dirmother,"/Base/Base_Final_Filtrada.RData"))
fname = paste0(dirmother,"/Base/Base_filtradas/01_Base_filtrada.RData")
...
fname = paste0(dirmother,"/Base/Base_filtradas/02_Base_filtrada_240.RData")
save(BASEDATOS,file=fname)
...
fname = paste0(dirmother,"/Base/Base_filtradas/03_Base_filtrada_2017_2019.RData")
save(BASEDATOS,file=fname)
...
fname = paste0(dirmother,"/Base/Base_filtradas/04_Base_filtrada_2019_270.RData")
save(BASEDATOS,file=fname)
