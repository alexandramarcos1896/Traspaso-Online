...
#Parte 1
load("../output/MasterData/Base_Total_Peru.RData")
anterior=DF_TOTAL

#Parte2
fname = "../output/MasterData/2018-09-14hasta2019-04-30.RData"
load(fname)
actual = DATA
...
# (5)Creacion de nuevas variables: Precios --------------------------------
...
filename=paste0("../output/MasterData/BasePERU_Proceso1.RData")
