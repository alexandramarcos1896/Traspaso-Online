regresion3 <- function(baseduracion,basetipocambio,j,s,y){
  ...
  #Regresion OLS
  #--------------
  reg1 <- lm(Dpre ~ 0 + d_ER + d_ER*categoria + DDias + control + PInicial+
               demeanedfreq,
             data = baseduracion)
  
  #Regresion FGLS
  #--------------
  reg2 <- lm(Dpre ~ 0 + d_ER + d_ER*categoria  + DDias + control + PInicial+
               demeanedfreq,
             data = baseduracion,
