...
while(fecha <= fin_d){
  fname = paste0("../BaseDatos/raw/falabella_per_",format(fecha,"%Y-%m-%d"),".RData")
  ...
  if(file.exists(fname)){
    ...
    "PASO 6: Exportar de los datos"
    
    # fname_R = paste("./_R/Falabella_per_",fecha,".Rdata",sep="")
    fname_R = paste("../BaseDatos/R1/Falabella_per_",fecha,".RData",sep="")
