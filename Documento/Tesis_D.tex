...
Finalmente, la no linealidad estudia el impacto diferenciado de pequeño movimiento del tipo de cambio contra un movimiento brusco. Este fen\'omeno implicaba que el comportamiento de los precios eran distinto ante subidas disruptivas en comparaci\'on de un incremento moderado del tipo de cambio.
\begin{equation} \label{eq7}
